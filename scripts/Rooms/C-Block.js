...
const apiResponse = {
    ...
    for (let roomNumber = 1; roomNumber <= totalRooms; roomNumber++) {
      ...
      switch (rooms[roomNumber]) {
        case 0:
          color = 'green';
          title = 'Empty Room'; // Available (green color)
          break;
        case 1:
          color = 'blue';
          title = 'Occupied by 1 person'; // Occupied by 1 person (blue color)
          break;
        case 2:
            color = 'red';
            title = 'Occupied by more than 1 person'; // Occupied by more than 1 person (red color)           
            break;
        default:
            color = '#BF4E03';
            title = 'Occupied by permanent person' // Occupied by permanent person (purple color)
